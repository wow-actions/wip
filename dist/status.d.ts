...
export declare namespace Status {
    function get(octokit: Octokit): Promise<State>;
    function hasChange(octokit: Octokit, nextState: State): Promise<boolean>;
    function update(octokit: Octokit, nextState: State): Promise<import("@octokit/types").OctokitResponse<{
        id: number;
        head_sha: string;
        node_id: string;
